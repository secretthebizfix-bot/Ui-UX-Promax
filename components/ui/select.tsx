  ...
  ({ className, children, ...props }, ref) => (
    <div className="relative">
      <select
        ref={ref}
        className={cn(
          "flex h-12 w-full appearance-none rounded-xl border border-input bg-background/50 px-4 py-2 pr-10 text-sm shadow-sm backdrop-blur transition-colors focus-visible:border-secondary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary/25 disabled:cursor-not-allowed disabled:opacity-50",
          className,
        )}
        {...props}
      >
